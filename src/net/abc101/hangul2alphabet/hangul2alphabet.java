...
public class hangul2alphabet {
	...
	/**
	 * 한글 초성 유니코드 리스트(19)
	 * First sound Korean character unicode
	 */
	...
	/**
	 * 한글 중성 유니코드 리스트(21)
	 * Middle sound Korean character unicode
	 */
	...
	/**
	 * 한글 종성 유니코드 리스트(28)
	 * Last sound Korean character unicode
	 */
	...
	public static String[] arrayJaumAlphabet = {
			"r", "R", "rt", "s",
			"sw", "sg", "e", "E",
			"f", "fr", "fa", "fq",
			"ft", "fx", "fv", "fg",
	...
	public static String[] arrayMoumAlphabet = {
			"k", "o", "i", "O",
			"j", "p", "u", "P",
			"h", "hk", "ho", "hl",
			"y", "n", "nj", "np",
